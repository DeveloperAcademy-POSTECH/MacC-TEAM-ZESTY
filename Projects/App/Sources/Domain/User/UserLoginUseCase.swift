    ...
    func getUserProfile() {
        ...
        UserAPI.getUserProfile(authorization: authorization)
            .sink { error in
                ...
                guard let self = self else { return }
                UserInfoManager.initialUserInfo(userNickname: userProfileDTO.nickname, userID: userProfileDTO.id, userOrganization: userProfileDTO.organization, userOrgName: nil)
